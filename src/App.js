...
function App() {
  ...
  return (
    <>
      <div className="h-screen relative" id="spline-container">
      ...
      <div className="flex w-screen h-full flex-col items-center justify-center relative bg-primary">
              ...
              >
                ...
                <div className="w-full h-420 flex flex-col items-center justify-center ">
                  <p className="text-lg text-textBase text-start">
                    ...
                    Golang, C++, Python, SQL, Java, C, JavaScript, Dart, Kotlin,
                    R
                    <br />
                    ...
                    Scientist with Python Career Track (2018), Chartered
                    Financial Analyst Level 1 (2019)
                  </p>
